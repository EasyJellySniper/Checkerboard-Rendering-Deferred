...
public:
	...
	virtual bool CacheNativeGBuffer(void *_src, int _frame, int _gBufferId) = 0;
	virtual bool CacheNativeDepth(void *_src, int _frame) = 0;
	virtual void ReleaseNativeCBR() = 0;
	virtual void SetCbrGBuffer() = 0;
	virtual void RestoreUnityGBuffer() = 0;
};
